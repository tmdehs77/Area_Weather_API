...
const url1 = `https://api.openweathermap.org/data/2.5/weather?q=Seoul&appid=${apiKey}`;

const url2 = `https://api.openweathermap.org/data/2.5/weather?q=Busan&appid=${apiKey}`;

const url3 = `https://api.openweathermap.org/data/2.5/weather?q=Daejeon&appid=${apiKey}`;

const url4 = `https://api.openweathermap.org/data/2.5/weather?q=Cheonan&appid=${apiKey}`;

const url5 = `https://api.openweathermap.org/data/2.5/weather?q=Ulsan&appid=${apiKey}`;
